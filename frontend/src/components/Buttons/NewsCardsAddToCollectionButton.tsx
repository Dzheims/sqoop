...
import { SAVE_ARTICLE_TO_COLLECTION } from '../Collections/query';
...
const NewsCardsAddToCollectionButton = ({ data }: DataProps) => {
...
export default NewsCardsAddToCollectionButton;
